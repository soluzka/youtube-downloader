...
# get node.js and python and C# and the dev kit then pip install and npm i youtube-dl-exec and python download_youtube.py and npm install binary-version-check pip install pytube youtube-search-python yt-dlp requests beautifulsoup4
